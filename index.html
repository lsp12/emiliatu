                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-5">
                            <div class="newsletter_text">
                                <h4>Suscribete</h4>
                                <p>Suscribete y recive nuestras ofertas de viaje a tu correo electronico.</p>
                            </div>
                        </div>
                        <div class="col-lg-7">
                            <div class="mail_form">
                                <div class="row no-gutters">
                                    ...
                                    <div class="col-lg-3 col-md-4">
                                        <div class="newsletter_btn">
                                            <button class="boxed-btn4 " type="submit" >Suscribirse</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="section_title text-center mb_70">
                        ...
                        <p>Visita los principales lugares turisticos de las ciudades mas hermosas del Ecuador.</p>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="single_place">
                        <div class="thumb">
                            <img src="img/place/ciudad-mitad.jpg" alt="">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_place">
                        <div class="thumb">
                            <img src="img/place/teleferico-quito.jpg" alt="">
                            <a href="#" class="prise">$500</a>
                        </div>
                        <div class="place_info">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_place">
                        <div class="thumb">
                            <img src="img/place/volcan pichincha.jpg" alt="">
                            <a href="#" class="prise">$500</a>
                        </div>
                        <div class="place_info">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_place">
                        <div class="thumb">
                            <img src="img/place/palacio-carondele.jpg" alt="">
                            <a href="#" class="prise">$500</a>
                        </div>
                        <div class="place_info">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_place">
                        <div class="thumb">
                            <img src="img/place/chocolatera-salinas.jpg" alt="">
                            <a href="#" class="prise">$500</a>
                        </div>
                        <div class="place_info">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_place">
                        <div class="thumb">
                            <img src="img/place/malecon-2000.jpg" alt="">
                            <a href="#" class="prise">$500</a>
                        </div>
                        <div class="place_info">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="more_place_btn text-center">
                        <a class="boxed-btn4" href="#">Mas lugares</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="single_travel text-center">
                        ...
                        <h3>Viaje confortante</h3>
                        <p>Nuestros buses cuentan con la ultima tecnologias y exelentes comodidades para que tengas la mejor experiencia.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="single_travel text-center">
                        ...
                        <p>Te llevamos a los mejores hoteles de las ciudades.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="single_travel text-center">
                        ...
                        <h3>Guia de viaje</h3>
                        <p>Te damos recomendaciones para que visites las Ciudades mas hermosas de Ecuador.</p>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    <div class="single_testmonial text-center">
                                        ...
                                        <p>"Fues una increible experiencia que tube visitando los lugares mas hermosos de Ecuador".</p>
                            ...
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    <div class="single_testmonial text-center">
                                        ...
                                        <p>"Las hermosas Playas Ecuatorianas me an fasinado".</p>
                                        <div class="testmonial_author">
                                            <h3>- Tom Mouse</h3>
                                        </div>
                                    </div>
                            ...
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    <div class="single_testmonial text-center">
                                        ...
                                        <p>"La vista desde el volcan Pichincha fue una experiencia unica en la vida. Gracias por el servicios".</p>
                                        <div class="testmonial_author">
                                            <h3>- Jerry Mouse</h3>
                                        </div>
                                    </div>
